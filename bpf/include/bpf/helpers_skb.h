...
static int BPF_FUNC(skb_load_bytes, struct __sk_buff *skb, __u32 off,
		    void *to, __u32 len);
static int BPF_FUNC(skb_load_bytes_relative, const void *skb, __u32 off,
                    void *to, __u32 len, __u32 start_header);
...
static int BPF_FUNC(sk_assign, struct __sk_buff *skb, struct bpf_sock *sk,
		    __u64 flags);
static int BPF_FUNC(sk_select_reuseport, struct sk_reuseport_md *reuse,
